    ...
    <div className='container-fluid features-bgm-main'>
        <div className='row animate__animated  animate__slideInRight '>
            ...
            <div className='col-12 text-center p-3'>
              ...
              <Sliderify showSpot={false} showNavButtons={false} showSlideStatus={true} 	slideDurationInSecs={20}>
        
        <div className='flex flex-col justify-center items-center'
          style={{padding:"5px", borderRadius:"10px 10px 10px 10px", backgroundColor: "transparent",border:"2px solid black", color: "white" }}
        >
